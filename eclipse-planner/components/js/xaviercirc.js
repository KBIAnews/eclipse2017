...
//
// Compute the local circumstances and return as JS Object
function loc_circ_obj(lat, lon) {
   var html = "";
   var htmlc1 = "";
   var htmlc2 = "";
   var htmlmid = "";
         ...
         if ((c1[31] <= 0.0) && (c4[31] <= 0.0)) {
            ...
            if ((c2[31] <= 0.0) && (c3[31] <= 0.0)) {
               ...
               if ((c2[31] > 0.0) && (c3[31] > 0.0)) {
                  ...
                  returnable.duration = getduration();
               }
               else {
   ...
   returnable.isEclipse = isEclipse;
   returnable.partialEvent = partialEvent;
   returnable.displayEclipseType = htmlEclipse;

   if (isEclipse == true) {
      var maxmag = Math.round(mid[34] * 1000) / 1000.0;
      returnable.magnitude = maxmag;
      returnable.coverage = getcoverage();
   }
